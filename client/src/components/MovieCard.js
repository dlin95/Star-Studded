...
const MovieCard = (props) => {
  ...
  const handleAddToWatchList = async function(e, movie_id) {
    ...
    return await axios.post('/api/watchlist', watchlist).then((result) => {
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className='mt-2 d-flex justify-content-between align-items-center'>
          <button type="button" className="btn btn-light mt-1" onClick={(e) => handleAddToWatchList(e, props.id)}><i className="fa-regular fa-plus me-1"></i>Watchlist</button>
